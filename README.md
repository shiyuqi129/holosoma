...
This project is a additional module for Holosoma with the idea of motion planning for a robot that only know how to walk in some direction according to the command received.

For more information, check out the [README](src/explorer/README.md) of this project.
